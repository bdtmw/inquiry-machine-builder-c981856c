...
export const LeadMagnetSection = () => (
  <section className="section-padding bg-background">
    <div className="container mx-auto max-w-5xl">
      <motion.div initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="bg-hero text-hero-foreground rounded-3xl relative overflow-hidden">
        ...
        <div className="relative z-10 p-10 md:p-16">
          <div className="grid md:grid-cols-2 gap-10 items-center">
            ...
            <div className="bg-hero-foreground/[0.04] border border-hero-foreground/10 rounded-2xl p-8">
              ...
              <Button variant="cta" size="lg" className="w-full text-base py-6 animate-pulse-glow" onClick={scrollToForm}>
                Get My Free Plan <ArrowRight className="h-5 w-5 ml-1" />
              </Button>
              <p className="text-xs text-center text-hero-foreground/40 mt-4">Free · No obligation · Takes 2 minutes</p>
            </div>
          </div>
        </div>
      </motion.div>
