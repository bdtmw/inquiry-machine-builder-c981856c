...
const plans = [
  {
    ...
    features: ["Full website build", "Ad campaign setup & management", "CRM & automation setup", "Monthly optimization", "Dedicated account manager"],
    recommended: false,
    cta: "Get Started",
  },
  {
    ...
    features: ["No upfront cost at all", "Full website build included", "Ad campaign management", "AI follow-up system", "Only pay for real results"],
    recommended: true,
    cta: "Start Risk-Free",
  },
];
