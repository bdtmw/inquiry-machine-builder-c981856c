...
const steps = [
  {
    ...
    desc: "Custom website, CRM, and automation — all set up and ready to capture leads.",
    color: "bg-accent/10",
  },
  {
    icon: Megaphone,
    num: "02",
    title: "We Drive Traffic",
    desc: "Targeted ads and SEO strategies to bring qualified prospects directly to you.",
    color: "bg-accent/10",
  },
  {
    icon: HandshakeIcon,
    ...
    desc: "Qualified leads land in your inbox. Just pick up the phone and close the deal.",
    color: "bg-accent/10",
  },
];
