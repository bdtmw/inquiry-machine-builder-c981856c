...
const testimonials = [
  {
    ...
    text: "ENQS completely transformed our lead flow. We went from 5 inquiries a month to over 40. The ROI has been incredible.",
    rating: 5,
  },
  {
    name: "James Kennedy",
    role: "Roofing Contractor",
    text: "The AI follow-up system alone has saved us hundreds of hours. We close more deals with less effort than ever before.",
    rating: 5,
  },
];
      ...
      <div className="grid md:grid-cols-3 gap-6 lg:gap-8 mb-20">
        {metrics.map(({ icon: Icon, value, label, sub }, i) => (
          <motion.div
            ...
            className="bg-card rounded-2xl p-8 text-center card-elevated border border-border/50 relative overflow-hidden"
          >
      ...
      <div className="grid md:grid-cols-2 gap-6 lg:gap-8 mb-14">
        {testimonials.map((t, i) => (
          <motion.div
            ...
            className="bg-card rounded-2xl p-8 md:p-10 card-elevated border border-border/50 relative"
          >
